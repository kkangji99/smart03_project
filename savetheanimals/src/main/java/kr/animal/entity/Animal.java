...
public class Animal {
   ...
   private String ani_occur_address_sub;
   ...
   public String getAni_occur_address_sub() {
      return ani_occur_address_sub;
   }


   public void setAni_occur_address_sub(String ani_occur_address_sub) {
      this.ani_occur_address_sub = ani_occur_address_sub;
   }
