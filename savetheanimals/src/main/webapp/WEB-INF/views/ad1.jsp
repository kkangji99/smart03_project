         ...
         <div class="tab-pane fade show active" id="dog">
            ...
            <fieldset>
               <div class="search-form">
                  <form name="SearchForm" method="post" action="${cpath}/searchDog.do" enctype="multipart/form-data">
   ...
   <c:choose>
    ...
    <div class="row mt-5">
		<div class="col text-center">
			<div class="block-27">
				<ul>
					<c:if test="${paging1.showPrev}">
			        <li><a href="${cpath}/ad1.do?curPage=1">&laquo;</a></li>
		            <li><a href="${cpath}/ad1.do?curPage=${paging1.curPage-1 }">&lt;</a></li>
		            </c:if>
		            <c:forEach begin="${paging1.firstPage}"  end="${paging1.lastPage}" var="i">
		                  <li><a href="${cpath }/ad1.do?curPage=${i}">  
		                     <c:if test="${i eq paging1.curPage }"> <span style="background:green; color:white; border-color:transparent;">${i}</span></c:if>
		                     <c:if test="${i ne paging1.curPage }">${i}</c:if> 
		                  </a></li>
		            </c:forEach>
		            
					<c:if test="${paging1.showNext}">
		            <li><a href="${cpath}/ad1.do?curPage=${paging1.curPage+1 }">&gt;</a></li>
		            <li><a href="${cpath}/ad1.do?curPage=${paging1.totalPageCount }">&raquo;</a></li>
		            </c:if>
		           </ul>
    		</div>
		</div>
