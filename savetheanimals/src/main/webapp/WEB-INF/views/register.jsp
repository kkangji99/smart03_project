    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item active"><a href="register" class="nav-link">유실동물 등록</a></li>
      ...
      <div class="row no-gutters slider-text align-items-end">
        <div class="col-md-9 ftco-animate pb-5">
          <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index">Home <i
                  class="ion-ios-arrow-forward"></i></a></span> <span>등록 <i class="ion-ios-arrow-forward"></i></span>
          </p>
        ...
        <div class="col-md-12">
          <div class="wrapper">
            ...
            <div class="row no-gutters">
              <div class="col-md-12">
                <div class="contact-wrap w-100 p-md-5 p-4">
                  <h3 class="mb-4" style="text-align: center;">정보</h3>
                  <form method="POST" id="contactForm" class="needs-validation" novalidate>
                    <div class="row col-md-12">
                      <div class="row col-md-6">
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                            <label for="validationCustom01">털색</label>
                            <select class="form-control custom-select" name="colors" id="colors" required>
                              <option></option>
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            <label class="label" for="number">연락처</label>
                            <input type="text" class="form-control" name="number" id="number" placeholder="연락처"
                              required>
                            <div class="valid-feedback"></div>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="label" for="date"> 목격/보호/유실 일자
                            </label>
                        ...
                        <div class="col-md-12">
                          <div class="form-group">
                            <label class="label" for="subject">목격/보호/유실 장소
                            </label>
                            <input type="text" class="form-control" name="place" id="place" placeholder="장소" required>
                            <div class="valid-feedback"></div>
                      ...
                      <div class="col-md-6 mx-auto text-center">
                        <div class="form-group" onclick="this.form.reset">
                          <input type="file" id="files" class="form-control filesImgs" name="image_file"
                            accept=".jpg, .jpeg, .png" multiple style="padding-left: 25%; font-size: 14px; " required>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="label" for="subject">나이</label>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label class="label" for="subject">보호 장소</label>
                          <input type="text" class="form-control" name="subject" id="subject" placeholder="보호 장소">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="label" for="gender">성별</label>
                          <div class="form-control custom-checkbox" style="display: flex;
                          justify-content: space-evenly;">
                            <input type="checkbox" id="customCheck1">암컷
                            <input type="checkbox" id="customCheck1">수컷
                            <input type="checkbox" id="customCheck1">미상
                          </div>
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="label" for="subject">축종</label>
                          <div class="form-control custom-checkbox" style="display: flex;
                          justify-content: space-evenly;">
                            <input type="checkbox" id="customCheck1">강아지
                            <input type="checkbox" id="customCheck1">고양이
                            <input type="checkbox" id="customCheck1">미상
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="col-md-4">
                        <div class="form-group">
                          <label class="label" for="subject">중성화여부</label>
                          <div class="form-control custom-checkbox" style="display: flex;
                          justify-content: space-evenly;">
                            <input type="checkbox" id="customCheck1">여
                            <input type="checkbox" id="customCheck1">부
                            <input type="checkbox" id="customCheck1">미상
                          </div>
                        </div>
                      </div>
                      <div class="col-md-12">
                        <div class="form-group">
                          ...
                          <textarea name="message" class="form-control" id="message" cols="30" rows="4"
                            placeholder="특이사항" style="resize: none;"></textarea>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-12">
            ...
            <!-- <button type="button" class="btn btn-primary btn-lg" data-toggle="modal"
                data-target="#myModal" style="font-size: 12px;">확인</button>
              ...
              <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <h2 class="modal-title" style="text-align: center;">등록 되었습니다!</h2>
                    <section class="ftco-section bg-light">
                      <div class="container">
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-6 col-lg-5 mb-2">
          ...
          <p>A country's greatness and morality can be judged by its attitude toward animals.</p>
